...
#             with self.client as c:
#                 url = "%s?script=sci_issuetoc&pid=%s" % (
#                     url_for("main.router_legacy", lang="pt"),
#                     issue.pid,
#                 )
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_article_pdf(self, mocked_get_pdf_content):
#         """
...
#         """
#         mocked_get_pdf_content.return_value = Response(
#             b"<pdf>", mimetype="application/pdf"
#         )

#         with current_app.app_context():
#             journal = utils.makeOneJournal(
#                 {"print_issn": "0000-0000", "url_segment": "journal_acron"}
#             )
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_article_pdf_with_tlng(self, mocked_get_pdf_content):
#         """
#         Testa o acesso ao PDF pela URL antiga verificando em todas as versões do pid
...
#         """
#         mocked_get_pdf_content.return_value = Response(
#             b"<es_content>", mimetype="application/pdf"
#         )
...
#             with self.client as c:
#                 url = "%s?script=sci_pdf&pid=%s&tlng=es" % (
#                     url_for("main.router_legacy", lang="pt"),
#                     article.pid,
#                 )
...
#                 expectedPath = "/pt/j/journal_acron/a/2586f2aadb65457c94fcee24c48b3d6c/"
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_article_pdf_without_tlng(self, mocked_get_pdf_content):
#         """
...
#         """
#         mocked_get_pdf_content.return_value = Response(
#             b"<en_content>", mimetype="application/pdf"
#         )
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_article_pdf_when_dont_have_the_pdf_translation(self, mocked_get_pdf_content):
#         """
#         Testa o acesso ao PDF pela URL antiga verificando em todas as versões do pid
...
#         """
#         mocked_get_pdf_content.return_value = Response(
#             b"<content>", mimetype="application/pdf"
#         )
...
#             # Verifica se o redirect para a URL com PID v3 está correta
#             with self.client as c:
#                 url = "%s?script=sci_pdf&pid=%s&tlng=xxx" % (
#                     url_for("main.router_legacy", lang="pt"),
#                     article.pid,
#                 )
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_article_pdf_looking_scielo_pids(self, mocked_get_pdf_content):
#         """
#         Testa o acesso ao PDF pela URL antiga verificando em todas as versões do pid
#         campo ``scielo_pids``.
#         URL testa: scielo.php?script=sci_pdf&pid=ISSN + ID DO número + ID DO ARTIGO
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_router_legacy_pdf(self, mocked_get_pdf_content):
#         """
...
#             with self.client as c:
#                 # Rota /pdf/ está sob /<lang>/pdf/
#                 url = "/pt/pdf/cta/v39s2/0101-2061-cta-fst30618.pdf"
...
#     @patch("opac.webapp.main.views.get_pdf_content")
#     def test_router_legacy_pdf_suppl_material(self, mocked_get_pdf_content):
#         """
...
#             with self.client as c:
#                 # Rota /pdf/ está sob /<lang>/pdf/
#                 url = "/pt/pdf/cta/v92n2/0101-2061-cta-suppl01.pdf"
...
#             with self.client as c:
#                 url = "%s?script=sci_arttext&pid=%s&tlng=%s" % (
#                     url_for("main.router_legacy", lang="pt"),
#                     article.pid,
#                     "en",
#                 )
...
#             with self.client as c:
#                 # URL legada está sob /<lang>/scielo.php/
...
#                 url_for("main.router_legacy", lang="pt"), follow_redirects=False
#             )
#             response_following = self.client.get(
#                 url_for("main.router_legacy", lang="pt"), follow_redirects=True
#             )
#             # then
...
#                 url_for("main.router_legacy", lang="pt") + qs, follow_redirects=True
#             )
