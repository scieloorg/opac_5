    ...
    def test_journal_detail_subject_areas_more_than_three(self):
        ...
        with self.client as c:
            ...
            for lang, expected in zip(
                ["en", "es", "pt_BR"],
                ["Multidisciplinary", "Multidisciplinaria", "Multidisciplinar"],
            ):
    ...
    def test_journal_with_twitter_social_networks_show_links(self):
        ...
        with current_app.app_context():
            ...
            journal_data = {
                ...
                "social_networks": [
                    {"network": "twitter", "account": "http://twitter.com/@foo"}
                ],
            }
    ...
    def test_journal_with_facebook_social_networks_show_links(self):
        ...
        with current_app.app_context():
            ...
            journal_data = {
                "collection": collection,
                "social_networks": [
                    {"network": "facebook", "account": "http://facebook.com/foo"}
                ],
            }
            journal = utils.makeOneJournal(journal_data)
            with self.client as c:
    ...
    def test_journal_with_googleplus_social_networks_show_links(self):
        ...
        with current_app.app_context():
            ...
            journal_data = {
                "collection": collection,
                "social_networks": [
                    {"network": "google", "account": "http://plus.google.com/+foo"}
                ],
            }
            journal = utils.makeOneJournal(journal_data)
            with self.client as c:
